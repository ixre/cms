...
namespace JR.Cms.Library.DataAccess.SQL
{
    public abstract class SqlPack
    {
        ...
        /// 重新发布文档
        /// </summary>
        public readonly string ArchiveRepublish =
            @"UPDATE $PREFIX_archive SET create_time=@create_time WHERE id =@id AND site_id=@siteId";
        ...
        /// 更新文档路径前缀
        /// </summary>
        public readonly string Archive_ReplaceArchivePath =
            @"UPDATE $PREFIX_archive SET path=REPLACE       (path,@old,@new) WHERE site_id=@siteId AND path LIKE @keyword";


        /// <summary>
        /// 增加浏览数量
        /// </summary>
        public readonly string Archive_AddViewCount =
            @"UPDATE $PREFIX_archive SET view_count=view_count+@count WHERE site_id=@siteId AND $PREFIX_archive.id=@id";
        ...
        /// 切换作者
        /// </summary>
        public readonly string ArchiveTransferPublisherId =
            "UPDATE $PREFIX_archive SET author_id=@toPublisherId WHERE author_id=@publisherId";
        ...
        public readonly string ArchiveGetPagedArchivesCountSqlPagerqurey = @"
            ...
            WHERE $PREFIX_category.site_id=@siteId AND "
                                                                           ...
                                                                           " AND $PREFIX_archive.cat_id IN ($[catIdArray])";
        ...
        */
        ...
        /// 更新排序号
        /// </summary>
        public string ArchiveUpdateSortNumber =
            "UPDATE $PREFIX_archive SET sort_number=@sort_number WHERE id=@archiveId";
        ...
        /// 根据用户名和密码获取用户信息
        /// </summary>
        public readonly string UserGetUserCredentialByUserName =
            "SELECT id,user_id,user_name,password,enabled FROM $PREFIX_credential WHERE user_name=@userName";

        public readonly string UserGetUserCredential =
            "SELECT id,user_id,user_name,password,enabled FROM $PREFIX_credential WHERE user_id=@userId";
        ...
        public readonly string UserGetUserIdByUserName =
            "SELECT user_id FROM $PREFIX_credential WHERE user_name=@userName";
        ...
        /// 更新用户
        /// </summary>
        public readonly string UserUpdateUser =
            @"UPDATE $PREFIX_user SET name=@name,avatar=@avatar,phone=@phone,email=@email,
        ...
        /// 创建新操作
        /// </summary>
        public readonly string Operation_CreateOperation =
            "INSERT INTO $PREFIX_operation (name,path,available) VALUES (@Name,@Path,@available)";

        /// <summary>
        /// 更新用户最后登录时间
        /// </summary>
        public string Member_UpdateUserLastLoginDate =
            "UPDATE $PREFIX_user SET LastLoginDate=@LastLoginDate WHERE username=@username";
        ...
        /// 更新操作
        /// </summary>
        public readonly string Operation_UpdateOperation =
            "UPDATE $PREFIX_operation SET name=@Name,path=@Path,available=@available WHERE id=@Id";
        ...
        /// 更新用户权限
        /// </summary>
        public readonly string UserGroup_UpdatePermissions =
            "UPDATE $PREFIX_usergroup SET permissions=@Permissions WHERE id=@GroupId";
        ...
        /// 查询文档评论数目
        /// </summary>
        public readonly string Comment_QueryCommentsCountForArchive =
            "SELECT count(id) FROM $PREFIX_comment WHERE archiveid=@ArchiveId";
        ...
        /// 获取链接
        /// </summary>
        public readonly string Link_GetSiteLinksByLinkType =
            @"SELECT * FROM $PREFIX_link WHERE $PREFIX_link.type=@linkType AND site_id=@siteId ORDER BY $PREFIX_link.sort_number";
        ...
        /// 写入新消息
        /// </summary>
        public readonly string Mesage_InsertMessage =
            @"INSERT INTO $PREFIX_Message ([SendUID],[ReceiveUID],[Subject],[Content],[HasRead],[Recycle],[SendDate])
                                                        VALUES(@SendUID,@ReceiveUID,@Subject,@Content,@HasRead,@Recycle,@SendDate)";

        /// <summary>
        /// 设置消息为已读
        /// </summary>
        public readonly string Message_SetRead =
            "UPDATE $PREFIX_Message SET [HasRead]=1 WHERE [receiveUID]=@ReceiveUID AND [ID]=@id";

        /// <summary>
        /// 将消息设为回收
        /// </summary>
        public readonly string Message_SetRecycle =
            "UPDATE $PREFIX_Message SET [Recycle]=1 WHERE [receiveUID]=@ReceiveUID AND [ID]=@id";

        /// <summary>
        /// 删除消息
        /// </summary>
        public readonly string Message_Delete =
            "DELETE FROM $PREFIX_Message WHERE [receiveUID]=@ReceiveUID AND [ID]=@id";

        /// <summary>
        /// 获取分页消息条数
        /// {0}->$[condition]
        /// </summary>
        public readonly string Message_GetPagedMessagesCount =
            "SELECT COUNT([ID]) FROM $PREFIX_Message WHERE Recycle=0 AND {0}";
        ...
        /// 检测用户名是否存在
        /// </summary>
        public readonly string Member_DetectUsernameAndNickNameHasExits =
            "SELECT id FROM $PREFIX_member WHERE username=@Username OR nickname=@Nickname";
        ...
        /// 写入会员的详细信息
        /// </summary>
        public readonly string Member_InsertMemberDetails =
            "INSERT INTO $PREFIX_memberdetails values(@UID,@Status,@RegIP,@RegTime,@LastLoginTime,@Token)";

        /// <summary>
        /// 根据会员ID获取会员信息及详细信息
        /// </summary>
        public readonly string Member_GetMemberInfoAndDetails =
            "SELECT * FROM $PREFIX_member INNER JOIN $PREFIX_memberdetails ON $PREFIX_member.id=$PREFIX_memberdetails.uid WHERE id=@id OR username=@Username";
        ...
        /// </summary>
        public readonly string Member_VerifyMember =
            "SELECT * FROM $PREFIX_member WHERE username=@UserName AND password=@password";
        ...
        /// 获取会员数
        /// </summary>
        public string Member_GetMemberCount =
            "SELECT COUNT(0) FROM $PREFIX_member INNER JOIN $PREFIX_memberdetails ON id=$PREFIX_memberdetails.uid";
        ...
        public readonly string Module_Add =
            "INSERT INTO $PREFIX_modules(site_id,name,isSystem,isDelete) VALUES(@siteId,@name,@isSystem,@isDelete)";
        ...
        public readonly string TplBind_Add =
            "INSERT INTO $PREFIX_tpl_bind (bind_id,bind_type,tpl_path) VALUES(@bindID,@bindType,@tplPath)";

        public readonly string TplBind_Update =
            "UPDATE $PREFIX_tpl_bind SET tpl_path=@tplPath WHERE bind_id=@bindID AND bind_type=@bindType";

        public readonly string TplBind_GetBind =
            "SELECT * FROM $PREFIX_tpl_bind WHERE bind_id=@bindID AND bind_type=@bindType";

        public readonly string TplBind_CheckExists =
            "SELECT count(0) FROM $PREFIX_tpl_bind WHERE bind_id=@bindID AND bind_type=@bindType";

        public readonly string TplBind_RemoveBind =
            "DELETE FROM $PREFIX_tpl_bind WHERE bind_id=@bindID AND bind_type=@bindType";
        ...
        /// 删除未关联的栏目模版
        /// </summary>
        public readonly string TplBind_RemoveErrorCategoryBind =
            "DELETE FROM $PREFIX_tpl_bind WHERE bind_id NOT IN (SELECT id FROM $PREFIX_category) AND bind_type IN(3,4)";
        ...
        /// 添加表格
        /// </summary>
        public readonly string Table_Add =
            "INSERT INTO $PREFIX_table (name,note,api_server,is_system,enabled) VALUES(@name,@note,@apiServer,@isSystem,@enabled)";
        ...
        /// 添加表格列
        /// </summary>
        public readonly string Table_CreateColumn =
            "INSERT INTO $PREFIX_table_column (table_id,name,note,valid_format,sort_number) VALUES(@tableId,@name,@note,@validFormat,@sortNumber)";

        /// <summary>
        /// 更新表格列
        /// </summary>
        public readonly string Table_UpdateColumn =
            "UPDATE $PREFIX_table_column SET name=@name,note=@note,valid_format=@validFormat,sort_number=@sortNumber WHERE id=@columnId";
        ...
        /// 删除列
        /// </summary>
        public readonly string Table_DeleteColumn =
            "DELETE FROM $PREFIX_table_column WHERE table_id=@tableId AND id=@columnId";
        ...
        /// 修改表格
        /// </summary>
        public readonly string Table_Update =
            "UPDATE $PREFIX_table set name=@name,note=@note,api_server=@apiServer,is_system=@isSystem,enabled=@enabled WHERE id=@tableId";
        ...
        /// 是否存在系统表格
        /// </summary>
        public readonly string Table_HasExistsSystemTale =
            "SELECT count(0) FROM $PREFIX_table WHERE id=@tableId AND isSystem";
        ...
        /// 获取所有列根据表格编号
        /// </summary>
        public readonly string TableGetColumnsByTableId =
            "SELECT * FROM $PREFIX_table_column WHERE table_id=@tableId ORDER BY sort_number ASC";

        /// <summary>
        /// 创建行
        /// </summary>
        public readonly string Table_CreateRow =
            "INSERT INTO $PREFIX_table_row (table_id,submit_time) VALUES(@tableId,@submitTime)";
        ...
        /// 清理删除的列在数据行中的数据
        /// </summary>
        public readonly string Table_ClearDeletedColumnData =
            "DELETE FROM $PREFIX_table_record WHERE row_id IN (SELECT id FROM $PREFIX_table_row WHERE table_id=@tableId) AND col_id=@columnId";


        /// <summary>
        /// 清理删除的行在数据行中的数据
        /// </summary>
        public readonly string Table_ClearDeletedRowData =
            "DELETE FROM $PREFIX_table_record WHERE row_id = (SELECT id FROM $PREFIX_table_row WHERE table_id=@tableId AND id=@rowId)";
