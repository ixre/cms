    ...
    public class CmsPluginContext
    {
        ...
        private void Load()
        {
            if (!this._loaded)
            {
                ...
                this._admJs = String.Concat(this._domain, "/", Settings.SYS_ADMIN_TAG, "?res=bWFuYWdlX2pzX21pbg==&amp;min.js&amp;ver=", Cms.Version);
                this._admCss = String.Concat(this._domain,"/", Settings.SYS_ADMIN_TAG, "?res=c3R5bGU=&amp;min.css&amp;ver=", Cms.Version);
