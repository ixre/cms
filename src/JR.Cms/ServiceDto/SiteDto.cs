...
namespace JR.Cms.ServiceDto
{
    ...
    public struct SiteDto
    {
        ...
        /// 目录名称
        /// </summary>
        [FormField("AppPath", Group = "basic", Text = "虚拟目录", Descript = "可指定虚拟目录名称,以\"http://abc.com/目录名称/\"访问站点",
        ...
        [FormField("location", Group = "basic", Text = "重定向",
            Descript = "可将首页重定向至指定URL,如：index.aspx将定位到www.xxx.com/index.aspx")]
        ...
        /// SEO标题
        /// </summary>
        [FormField("SeoTitle", Group = "basic", Text = "SEO标题", MultLine = true, Descript = "选填,不超过100字",
            Length = "[0,100]")]
        ...
        /// SEO关键字
        /// </summary>
        [FormField("SeoKeywords", Group = "basic", Text = "首页关键字", MultLine = true, Descript = "不超过150字",
            Length = "[0,150]")]
