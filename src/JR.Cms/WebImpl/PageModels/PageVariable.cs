...
namespace JR.Cms.WebImpl.PageModels
{
    ...
    <![endif]-->";
        ...
        public string Version
        {
            get
            {
                int i = CmsVariables.VERSION.LastIndexOf(".", StringComparison.Ordinal);
        ...
        public string Lang
        {
            get { return this._lang ??= Cms.Context.UserLanguage.ToString(); }
        }
        ...
        public string Sitemap
        {
            get
            {
                if (_sitemap == null)
                {
                    ...
                    {
                        string cacheKey = String.Format("{0}_site{1}_site_map_{2}", CacheSign.Category, siteId.ToString(), tag);
