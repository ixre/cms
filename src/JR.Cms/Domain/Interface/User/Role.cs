...
namespace JR.Cms.Domain.Interface.User
{
    ...
    public static class Role
    {
        ...
        public static IList<RoleValue> GetRoles(int roleFlag)
        {
            ...
            if ((roleFlag & Master.Flag) != 0) list.Add(Master);

            if ((roleFlag & SiteOwner.Flag) != 0) list.Add(SiteOwner);

            if ((roleFlag & Publisher.Flag) != 0) list.Add(Publisher);
            return list;
        }
