...
namespace JR.Cms.Domain.Site
{
    internal class Site : ISite
    {
        ...
        {
            return this._linkManager ??= new SiteLinkManager(this._siteRepository, this);
        }
        ...
        {
            return this._appUserManager ??= this._userRep.GetAppUserManager(this.GetAggregaterootId());
        }
