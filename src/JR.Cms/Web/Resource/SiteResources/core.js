 ...
 * 2019-03-25  $.animate方法
 ...
 function JR() {
    ...
    /*** 初始化 ***/
    this.__init__ = function(_Extend_PROTOTYPE) {
        //设置当前版本
    ...
    this.__extendingJsPrototype__ = function() {
        ...
        if (typeof(HTMLElement) != "undefined") {
            ...
            HTMLElement.prototype.realEval = function(expr) {
                var old = this.setStyle({ "display": "inherit",
...
JR.prototype = {
    ...
    animation: {
        ...
        toggle: function(e, speed, callback) {
            ...
            var arr = e.realEval(function(e) { return [e.clientWidth, e.clientHeight] });
            var width = arr[0];
            var height = arr[1];
        ...
        slideDown: function(e, speed, callback) {
            var src = e.raw ? e.raw() : e;
            var height = src.realEval(function(e) { return e.clientHeight; });
...
JR.prototype.xhr = {
    ...
    get: function(url, success, err) {
        this._doRequest(url instanceof Object ? this.getUrl(url) : { uri: url }, this._callback(success, err));
    },
