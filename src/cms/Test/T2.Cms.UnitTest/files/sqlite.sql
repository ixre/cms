...
CREATE TABLE "cms_archive" ("id" integer PRIMARY KEY  NOT NULL ,"str_id" varchar(16) NOT NULL  DEFAULT (null) ,"alias" varchar(50),"cid" integer DEFAULT (0) ,"publisher_id" integer DEFAULT (null) ,"title" varchar(100),"flags" varchar(100),"tags" varchar(100),"outline" varchar(255),"content" memo,"thumbnail" varchar(150),"view_count" integer DEFAULT (0) ,"agree" integer,"disagree" integer,"createDate" datetime,"lastModifyDate" datetime,"source" nvarchar(50),"location" nvarchar(150),"small_title" varchar(100),"sort_number" INTEGER NOT NULL  DEFAULT (0) );

DROP TABLE IF EXISTS "cms_category";
CREATE TABLE "cms_category" ("id" integer PRIMARY KEY  NOT NULL  DEFAULT (null) ,"site_id" integer NOT NULL  DEFAULT (1) ,"page_title" varchar(150) DEFAULT ('0') ,"moduleid" integer DEFAULT (0) ,"tag" varchar(50) DEFAULT ('null') ,"name" varchar(80) DEFAULT ('null') ,"page_keywords" varchar(100) DEFAULT ('null') ,"page_description" varchar(200) DEFAULT ('null') ,"lft" integer DEFAULT (0) ,"rgt" integer DEFAULT (0) ,"sort_number" integer DEFAULT (0) ,"location" nvarchar(150),"icon" nvarchar(150));
INSERT INTO "cms_category" VALUES (1,1,"-","1","root","根栏目","-","-",1,4,"1",null,null);
INSERT INTO "cms_category" VALUES (2,1,"-","1","cms","文章文类1","-","-",2,4,"1",null,null);
