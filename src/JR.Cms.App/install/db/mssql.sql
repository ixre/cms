...
INSERT [cms_archive] ([aid],[id],[alias],[cid],[author_id],[title],[content],[properties],view_count,[agree],[disagree],[createdate],[update_time],[flags]) VALUES ( 1,N'spcnet',N'welcome',2,N'admin',N'��ӭʹ��Special Cms .NET',N'<div style="text-align:center;font-size:30px"><h2>??�騨??????����Special Cms .NET!</h2></div>',N'{}',1,0,0,N'2013/1/1 1:01:01',N'2013/1/1 1:01:01',N'{st:''0'',sc:''0'',v:''1'',p:''0''}')
...
INSERT [cms_category] ([id],[siteid],[module_id],[tag],[name],[lft],[rgt],[orderindex]) VALUES ( 1,0,1,N'root',N'����Ŀ',1,4,0)
INSERT [cms_category] ([id],[siteid],[module_id],[tag],[name],[lft],[rgt],[orderindex]) VALUES ( 2,1,1,N'cms',N'��ӭʹ��',2,3,0)
...
INSERT [cms_site] ([siteid],[name],[language],[tpl],[seotitle],[state],[pronotice]) VALUES ( 1,N'Ĭ��վ��',1,N'default',N'Ĭ��վ��-Speicial Cms .NET!',1,N'JR-CMS.NET��һ���ƽ̨֧�ֶ�վ�����ASP.NET MVC�����ܹ������ݹ���ϵͳ!')
