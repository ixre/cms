/* KindEditor 4.1.10 (2013-11-23), Copyright (C) kindsoft.net, Licence: http://www.kindsoft.net/license.php */ (function (
  ...
  function G(a, c, g) {
    a.addEventListener
      ? a.addEventListener(c, g, fb)
      : a.attachEvent && a.attachEvent("on" + c, g);
  }
  function C(a, c, g) {
    a.removeEventListener
      ? a.removeEventListener(c, g, fb)
      : a.detachEvent && a.detachEvent("on" + c, g);
  }
  function u(a, c) {
    this.init(a, c);
  }
  ...
  function Fa(a, c) {
    ...
    function k(a, c, g) {
      ...
      if (g.getElementsByClassName) {
        ...
        d = d.querySelectorAll(
          (g.nodeName !== "#document" ? g.nodeName + " " : "") + c + "." + a
        );
        k = 0;
    ...
    function w(a, c, b, d) {
      for (
        var t = [], b = d.getElementsByTagName(b), V = 0, k = b.length;
        V < k;
        V++
      )
        (d = b[V]),
        ...
        if (v > 0) {
          ...
          for (E = l.length; q < E; q++) {
            ...
            for (u = j.length; B < u; B++)
              (p = j[B]), o ? r === p.parentNode && s.push(p) : s.push(p);
          }
          l = s;
        } else l = i(m, c);
  ...
  function Ob(a, c) {
    var g = ja(a),
      ...
      d = "";
    g.getComputedStyle
      ? ((g = g.getComputedStyle(a, null)),
        (d = g[b] || g.getPropertyValue(c) || a.style[b]))
      : a.currentStyle && (d = a.currentStyle[b] || a.style[b]);
    return d;
  }
  function X(a) {
    a = a || document;
  ...
  function Ra(a, c, g) {
      ...
      for (var m = d.firstChild, s; m; ) {
        ...
        if (h > 0)
          if (m.nodeType == 1)
            ...
            ((m =
              m == f.startContainer
                ? b(m, f.startOffset, m.nodeValue.length)
                : m == f.endContainer
                ? b(m, 0, f.endOffset)
                : b(m, 0, m.nodeValue.length)),
            c)
          )
            try {
              t.appendChild(m);
    ...
    if (m.nodeType == 3)
      return (
        (m = b(m, a.startOffset, a.endOffset)),
        c && s.appendChild(m),
        d(),
        c ? s : a
      );
  ...
  function mb(a, c) {
    ...
    for (var l = 0, n = k.length; l < n; l++) {
      ...
      if (o.nodeType == 1) {
        ...
        o.nodeType == 3 &&
          (h.moveStart("character", o.nodeValue.length),
          (e += o.nodeValue.length));
      f < 0 && (w = o);
    }
    if (f < 0 && w.nodeType == 1)
      return { node: d, offset: i(d.lastChild).index() + 1 };
  ...
  function ob(a) {
    ...
    if (Y) {
      if (a.item)
        return (g = ia(a.item(0))), (g = new aa(g)), g.selectNode(a.item(0)), g;
  ...
  function tb(a) {
    a.nodeName &&
      ((a = ia(a)), (a = Sa(a).selectNodeContents(a.body).collapse(!1)));
    return new va(a);
  }
  function Xa(a) {
    var c = a.moveEl,
  ...
  function cb(a, c) {
    var g =
        ...
        (da ? document.body : document.documentElement),
    ...
    b.onload = b.onreadystatechange = function () {
      if (!this.readyState || this.readyState === "loaded")
        c && c(), (b.onload = b.onreadystatechange = null), g.removeChild(b);
    };
  }
  function zb(a) {
    var c = a.indexOf("?");
      ...
      i(g).keydown(function (i) {
        if (!(i.which != 13 || i.shiftKey || i.ctrlKey || i.altKey)) {
          ...
          e == "marquee" ||
            ...
            (b === "br" && !d[e]
              ? (i.preventDefault(),
                c.insertHtml("<br />" + (F && N < 9 ? "" : "\u200b")))
              : k[e] || ea(g, "formatblock", "<p>"));
        }
      });
      i(g).keyup(function (d) {
        if (
          !(d.which != 13 || d.shiftKey || d.ctrlKey || d.altKey) &&
          b != "br"
        )
          if (la) {
  ...
  function Vb() {
    var a = this;
    i(a.edit.textarea[0], a.edit.win)
      .focus(function (c) {
  ...
  function Eb(a, c) {
    ...
    g.designMode
      ? (g.html(e.html), e.start && (d.moveToBookmark(e), this.select()))
      : i(b).html(ha(e.html));
    return this;
  }
  function Ba(a) {
  ...
  if (!b.KindEditor) {
    ...
    var Ka = "4.1.10 (2013-11-23)",
      ...
      Y = !b.getSelection,
      N = (J = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(J))
        ? J[1]
        : "0",
      Ja = new Date().getTime(),
      fa = Math.round,
    ...
    i.basePath = (function () {
      for (
        var a = document.getElementsByTagName("script"), c, g = 0, b = a.length;
        g < b;
        g++
      )
    ...
    A(u, {
      init: function (a, c) {
        ...
        if (!g.relatedTarget && g.fromElement)
          g.relatedTarget =
            g.fromElement === g.target ? g.toElement : g.fromElement;
        ...
        if (
          !g.which &&
          (g.charCode || g.charCode === 0 ? g.charCode : g.keyCode)
        )
    ...
    A(P, {
      init: function (a) {
        for (var a = f(a) ? a : [a], c = 0, g = 0, b = a.length; g < b; g++)
          a[g] && ((this[g] = a[g].constructor === P ? a[g][0] : a[g]), c++);
        this.length = c;
        this.doc = ia(this[0]);
        this.name = Pa(this[0]);
      ...
      attr: function (a, c) {
        ...
        if (c === d)
          return (c = g.length < 1 ? null : Ea(g[0], a)), c === null ? "" : c;
        g.each(function () {
          Oa(this, a, c);
        });
        return g;
      ...
      after: function (a) {
        this.each(function () {
          this.nextSibling
            ? this.parentNode.insertBefore(i(a)[0], this.nextSibling)
    ...
    A(aa, {
      ...
      commonAncestor: function () {
        ...
        for (
          var c = a(this.startContainer),
            b = a(this.endContainer),
            d = 0,
            i = c.length,
            k = b.length,
            e,
          ...
          a.nodeType == 3 &&
            (b === 0
              ...
              : b == a.nodeValue.length &&
                (d ? c.setStartAfter(a) : c.setEndAfter(a)));
        }
        var c = this;
        a(c.startContainer, c.startOffset, !0);
        a(c.endContainer, c.endOffset, !1);
    ...
    A(va, {
      ...
      selection: function (a) {
        ...
        b =
          Y && (!d || (!d.item && d.parentElement().ownerDocument !== c))
            ? null
            : d;
        this.sel = Ta(c);
        if (b)
          return (
            (this.range = Sa(b)),
            i(this.range.startContainer).name == "html" &&
              this.range.selectNodeContents(c.body).collapse(!1),
            this
          );
      ...
      select: function (a) {
        ...
        if (Y)
          ...
          l && b.collapse(!1),
            ...
            c.addRange(h),
            k !== document &&
              ((b = i(h.endContainer).pos()), f.scrollTo(b.x, b.y));
        f.focus();
        return this;
      },
      wrap: function (a) {
        ...
        b = i(a, this.doc);
        if (c.collapsed)
          return c.shrink(), c.insertNode(b[0]).selectNodeContents(b[0]), this;
        if (b.isBlock()) {
        ...
        i(a).scan(function (a) {
          if (!k && a == e.start) k = !0;
            ...
            if (!d && c.type == 3 && m(a.nodeValue).length > 0) {
              for (
                var f;
                (f = c.parent()) && f.isStyle() && f.children().length == 1;
              ...
              if (c.type == 3) Wa(f).append(c.clone(!1)), c.replaceWith(f);
                ...
                for (var l = h, n = !1; f; ) {
                  for (; l; )
                    l.name === f.name && (Qb(l, f.attr(), f.css()), (n = !0)),
                      (l = l.first());
      ...
      split: function (a, c) {
        for (
          var b = this.range,
            d = b.doc,
            e = b.cloneRange().collapse(a),
            k = e.startContainer,
            f = e.startOffset,
            h = k.nodeType == 3 ? k.parentNode : k,
            l = !1,
            n;
          h && h.parentNode;
        ...
        if (l)
          (d = d.createElement("span")),
            ...
            a
              ? e.setStartBefore(h.firstChild).setEnd(k, f)
              : e.setStart(k, f).setEndAfter(h.lastChild),
            (k = e.extractContents()),
            (f = k.firstChild),
            (l = k.lastChild),
            a
              ? (e.insertNode(k), b.setStartAfter(l).setEndBefore(d))
              : (h.appendChild(k), b.setStartBefore(d).setEndBefore(f)),
            (e = d.parentNode),
            e == b.endContainer &&
              ((h = i(d).prev()),
              (k = i(d).next()),
              h && k && h.type == 3 && k.type == 3
                ? b.setEnd(h[0], h[0].nodeValue.length)
                : a || b.setEnd(b.endContainer, b.endOffset - 1)),
            e.removeChild(d);
        return this;
      },
      remove: function (a) {
        ...
        if (d > 0) {
          ...
          m &&
            pa(m) &&
            (m.remove(), b.setStart(c, d - 1), c == e && b.setEnd(e, o - 1));
      ...
      val: function (a) {
        ...
        if (a === "forecolor")
          return (
            (a = this.commonNode({ "*": ".color" })) && (b = a.css("color")),
            (b = r(b)),
            b === "" && (b = "default"),
            b.toLowerCase()
          );
    ...
    A(ga, {
      ...
      pos: function (a, c, b) {
        b = q(b, !0);
        if (a !== null && ((a = a < 0 ? 0 : o(a)), this.div.css("left", a), b))
          this.x = a;
        if (c !== null && ((c = c < 0 ? 0 : o(c)), this.div.css("top", c), b))
          this.y = c;
        return this;
      },
    ...
    A(xa, ga, {
      init: function (a) {
        function c() {
          ...
          ka &&
            i(c).click(function (a) {
              i(a.target).name === "img" &&
                (l.selection(!0), l.range.selectNode(a.target), l.select());
            });
          if (F)
          ...
          F
            ? ((c.body.disabled = !0),
              ...
              c.body.removeAttribute("disabled"))
            : (c.designMode = "on");
        ...
        b.tabIndex = isNaN(parseInt(a.tabIndex, 10))
          ? b.srcElement.attr("tabindex")
      ...
      html: function (a, c) {
        ...
        if (this.designMode) {
          ...
          if (a === d)
            return (
              (a = c
                ? "<!doctype html><html>" + b.parentNode.innerHTML + "</html>"
                : b.innerHTML),
    ...
    A(Ga, ga, {
        ...
        d.div
          ...
          .click(function (a) {
            ...
            b &&
              ...
              d.options.click.call(this, a, b.attr("data-name"));
          });
      },
      get: function (a) {
      ...
      disableAll: function (a, c) {
        ...
        c && (e = z(c));
        (a === d ? !b.disableMode : a)
          ? (i("span.ke-outline", b.div).each(function () {
              var a = i(this),
    ...
    A(ya, ga, {
      ...
      addItem: function (a) {
        if (a.title === "-")
          ...
          var h;
          this.centerLineMode &&
            ((h = i('<div class="ke-inline-block ke-menu-item-center"></div>')),
            e && h.css("height", e));
    ...
    A(bb, {
      init: function (a) {
        ...
        for (o in f)
          n.push(
            '<input type="hidden" name="' + o + '" value="' + f[o] + '" />'
          );
        b = [
          '<div class="ke-inline-block ' + h + '">',
          a.target
            ? ""
            : '<iframe name="' + l + '" style="display:none;"></iframe>',
          a.form
        ...
        c.bind("load", function () {
          ...
          try {
            ...
            a.options.afterError.call(
              a,
              "<!doctype html><html>" + b.body.parentNode.innerHTML + "</html>"
            );
          }
    ...
    A(Aa, ga, {
      init: function (a) {
        ...
        F && N < 7
          ...
          : c && i('<div class="ke-dialog-shadow"></div>').appendTo(this.div);
        c = i('<div class="ke-dialog-header"></div>');
        s.append(c);
        c.html(b);
        this.closeIcon = i(
          '<span class="ke-dialog-icon-close" title="' + o.name + '"></span>'
        ).click(o.click);
    ...
    Ba.prototype = {
      ...
      resize: function (a, c, b) {
        ...
        if (
          a &&
          (/%/.test(a) ||
            ((a = l(a)), (a = a < this.minWidth ? this.minWidth : a)),
        ...
        if (
          ...
          ((c = l(c)),
          (editHeight =
            l(c) - this.toolbar.div.height() - this.statusbar.height()),
          (editHeight =
      ...
      addBookmark: function (a) {
        ...
        if (
          ...
          Math.abs(
            d.length -
              ha(this._undoStack[this._undoStack.length - 1].html).length
          ) < this.minChangeSize
        )
          return this;
      ...
      readonly: function (a) {
        var a = q(a, !0),
          ...
          d = b.doc;
        c.designMode
          ? c.toolbar.disableAll(a, [])
          : h(c.noDisableItems, function () {
    ...
    Ab("core", function (a) {
      ...
      c.clickToolbar("source", function () {
        c.edit.designMode
          ? (c.toolbar.disableAll(!0),
            c.edit.design(!1),
            c.toolbar.select("source"))
          : (c.toolbar.disableAll(!1),
            c.edit.design(!0),
      ...
      c.afterCreate(function () {
        function b() {
          ...
          f.remove();
          d !== "" &&
            (ka && (d = d.replace(/(<br>)\1/gi, "$1")),
            c.pasteType === 2 &&
              ((d = d.replace(/(<(?:p|p\s[^>]*)>) *(<\/p>)/gi, "")),
              /schemas-microsoft-com|worddocument|mso-\w+/i.test(d)
                ? (d = U(d, c.filterMode ? c.htmlTags : a.options.htmlTags))
                : ((d = H(d, c.filterMode ? c.htmlTags : null)),
                  (d = c.beforeSetHtml(d)))),
            c.pasteType === 1 &&
              ((d = d.replace(/&nbsp;/gi, " ")),
              (d = d.replace(/\n\s*\n/g, "\n")),
        ...
        yesBtn: {
          ...
          click: function () {
            var b = v.map,
              ...
              b = [
                s[0].checked
                  ? d.pluginsPath + "baidumap/index.html"
...
KindEditor.plugin("clearhtml", function (b) {
  ...
  d.clickToolbar("clearhtml", function () {
    d.focus();
    var f = d.html(),
      f = f.replace(/(<script[^>]*>)([\s\S]*?)(<\/script>)/gi, ""),
      f = f.replace(/(<style[^>]*>)([\s\S]*?)(<\/style>)/gi, ""),
      f = b.formatHtml(f, {
        a: ["href", "target"],
        embed: [
          "src",
          ...
          click: function () {
            var h = b(".ke-code-type", j.div).val(),
              ...
              h =
                ...
                "</pre> ";
            b.trim(m) === ""
              ? (alert(f.pleaseInput), e[0].focus())
              : d.insertHtml(h).hideDialog().focus();
          },
        },
      }),
      e = b("textarea", j.div);
...
KindEditor.plugin("emoticons", function (b) {
  ...
  d.clickToolbar("emoticons", function () {
    function h(e, h, l) {
      B
        ? e.mouseover(function () {
            h > D
              ? (B.css("left", 0), B.css("right", ""))
              : (B.css("left", ""), B.css("right", 0));
            G.attr("src", f + l + ".gif");
      ...
      e.click(function (b) {
        d.insertHtml('<img src="' + f + l + '.gif" border="0" alt="" />')
          .hideMenu()
          .focus();
        b.stop();
      });
    ...
    var B, G;
    j &&
      ((B = b('<div class="ke-preview"></div>').css("right", 0)),
...
KindEditor.plugin("filemanager", function (b) {
  function d(b, d) {
    d.is_dir
      ? b.attr("title", d.filename)
      : b.attr(
          "title",
          d.filename +
            " (" +
            Math.ceil(d.filesize / 1024) +
            "KB, " +
            d.datetime +
            ")"
        );
  ...
  f.plugin.filemanagerDialog = function (m) {
    ...
    function l(d, e) {
      function f() {
        C.val() == "VIEW"
          ? n(d.current_dir_path, u.val(), v)
          : n(d.current_dir_path, u.val(), s);
      }
      b.each(I, function () {
        this.unbind();
      });
    ...
    function s(d) {
      ...
      for (var n = d.file_list, m = 0, j = n.length; m < j; m++) {
        ...
        var q = b(
          ...
          q = b(p[0].insertCell(0))
            .addClass("ke-cell ke-name")
            .append(q)
            .append(document.createTextNode(" " + r.filename));
        !r.is_dir || r.has_file
          ? (p.css("cursor", "pointer"),
            q.attr("title", r.filename),
            o(q, d, r, s))
          : q.attr("title", h.emptyFolder);
        b(p[0].insertCell(1))
          .addClass("ke-cell ke-size")
          .html(r.is_dir ? "-" : Math.ceil(r.filesize / 1024) + "KB");
...
KindEditor.plugin("flash", function (b) {
  ...
  d.plugin.flash = {
    edit: function () {
      var l = [
          '<div style="padding:20px;"><div class="ke-dialog-row">',
          '<label for="keUrl" style="width:60px;">' + f.url + "</label>",
          ...
          '<label for="keWidth" style="width:60px;">' + f.width + "</label>",
          ...
          '<label for="keHeight" style="width:60px;">' + f.height + "</label>",
          ...
          yesBtn: {
            ...
            click: function () {
              ...
              e == "http://" || b.invalidUrl(e)
                ? (alert(d.lang("invalidUrl")), p[0].focus())
                : /^\d*$/.test(f)
                ? /^\d*$/.test(h)
                  ? ((e = b.mediaImg(d.themesPath + "common/blank.gif", {
                      src: e,
  ...
  d.plugin.imageDialog = function (f) {
    ...
    var C = [
        ...
        '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' +
          ...
          '" />',
        '</span></div><div class="ke-dialog-row">',
        '<label for="remoteWidth" style="width:60px;">' + p.size + "</label>",
        p.width +
          ...
          click: function () {
            if (!I.isLoading)
              if ((q && j && H && H.selectedIndex === 1) || !j)
                U.fileBox.val() == ""
                  ? alert(d.lang("pleaseSelectFile"))
                  : (I.showLoading(d.lang("uploadLoading")),
                    U.submit(),
                    qa.val(""));
              else {
                var e = b.trim(T.val()),
                ...
                e == "http://" || b.invalidUrl(e)
                  ? (alert(d.lang("invalidUrl")), T[0].focus())
                  : /^\d*$/.test(f)
                  ? /^\d*$/.test(h)
                    ? B.call(d, e, l, f, h, 0, n)
                    : (alert(d.lang("invalidHeight")), K[0].focus())
                  : (alert(d.lang("invalidWidth")), M[0].focus());
              }
          },
        },
        beforeRemove: function () {
      ...
      H;
    j && q
      ? ((H = b.tabs({ src: b(".tabs", E), afterSelect: function () {} })),
        H.add({ title: p.remoteImage, panel: b(".tab1", E) }),
        H.add({ title: p.localImage, panel: b(".tab2", E) }),
        H.select(A))
      : j
      ? b(".tab1", E).show()
      : q && b(".tab2", E).show();
    var U = b.uploadbutton({
      ...
      afterUpload: function (f) {
        ...
        if (f.error === 0) {
          ...
          v
            ? (b(".ke-dialog-row #remoteUrl", E).val(h),
              b(".ke-tabs-li", E)[0].click(),
              b(".ke-refresh-btn", E).click())
            : B.call(d, h, f.title, f.width, f.height, f.border, f.align);
        ...
        clickFn: function (e, f, h, l, n, o) {
          b
            ? (b.attr("src", e),
              ...
              b.attr("align", o),
              b.attr("alt", f))
            : d.exec("insertimage", e, f, h, l, n, o);
          setTimeout(function () {
            d.hideDialog().focus();
          }, 0);
        },
    ...
    var s = b.undef(l.fileUrl, "http://"),
      ...
      l = [
        ...
        '<input type="button" class="ke-button-common ke-button" name="viewServer" value="' +
          ...
          '" />',
        '</span></div><div class="ke-dialog-row">',
        '<label for="keTitle" style="width:60px;">' + o.title + "</label>",
        ...
        yesBtn: {
          ...
          click: function () {
            var e = b.trim(D.val()),
              f = q.val();
            e == "http://" || b.invalidUrl(e)
              ? (alert(d.lang("invalidUrl")), D[0].focus())
              : (b.trim(f) === "" && (f = e), p.call(d, e, f));
          },
        },
      }),
      z = r.div,
          ...
          yesBtn: {
            ...
            click: function () {
              ...
              f == "http://" || b.invalidUrl(f)
                ? (alert(d.lang("invalidUrl")), e[0].focus())
                : d.exec("createlink", f, h.val()).hideDialog().focus();
            },
          },
        }).div,
...
(function (b) {
  ...
  b.extend(d, {
      ...
      var h = {
        ...
        upload_error_handler: function (d) {
          d &&
            ...
            ((d = b('div[data-id="' + d.id + '"]', e.bodyDiv).eq(0)),
    ...
    appendFile: function (d) {
      var j = this,
        e = b(
          '<div class="ke-inline-block ke-item" data-id="' + d.id + '"></div>'
        );
      j.bodyDiv.append(e);
      ...
      b(
        '<div class="ke-progressbar"><div class="ke-progressbar-bar"><div class="ke-progressbar-bar-inner"></div></div><div class="ke-progressbar-percent">0%</div></div>'
      )
        .hide()
        .appendTo(m);
      b(
        '<div class="ke-message">' + j.options.pendingMessage + "</div>"
      ).appendTo(m);
    ...
    (SWFUpload.queue = {}),
      ...
      (SWFUpload.queue.uploadStartHandler = function (b) {
        ...
        typeof this.queueSettings.user_upload_start_handler === "function" &&
          (d = this.queueSettings.user_upload_start_handler.call(this, b));
        d = d === !1 ? !1 : !0;
...
KindEditor.plugin("pagebreak", function (b) {
  ...
  d.clickToolbar("pagebreak", function () {
    ...
    d.focus();
    var h =
      d.newlineTag == "br" || b.WEBKIT
        ? ""
        : '<span id="__kindeditor_tail_tag__"></span>';
    d.insertHtml(f + h);
    h !== "" &&
      ((h = b("#__kindeditor_tail_tag__", d.edit.doc)),
  ...
  f.clickToolbar("quickformat", function () {
    ...
    for (
      ...
      if (!v || v.name != "img")
        if (
          (j[m.name]
            ? (m.html(m.html().replace(/^(\s|&nbsp;|\u3000)+/gi, "")),
              m.css("text-indent", "2em"))
            : l.push(m),
...
KindEditor.plugin("table", function (b) {
  ...
  e.plugin.table = {
    prop: function (n) {
      var o = [
          '<div style="padding:20px;"><div class="ke-dialog-row">',
          '<label for="keRows" style="width:90px;">' + h.cells + "</label>",
          h.rows +
          ...
          '</div><div class="ke-dialog-row">',
          '<label for="keWidth" style="width:90px;">' + h.size + "</label>",
          h.width +
          ...
          '<label for="kePadding" style="width:90px;">' + h.space + "</label>",
          h.padding +
          ...
          '</div><div class="ke-dialog-row">',
          '<label for="keAlign" style="width:90px;">' + h.align + "</label>",
          ...
          '</select></div><div class="ke-dialog-row">',
          '<label for="keBorder" style="width:90px;">' + h.border + "</label>",
          h.borderWidth +
                      ...
                      if (/^\d*$/.test(H)) {
                        if (u)
                          h !== "" ? u.width(h + o) : u.css("width", ""),
                            ...
                            O !== ""
                              ? (u[0].cellPadding = O)
                              : u.removeAttr("cellPadding"),
                            Q !== ""
                              ? (u[0].cellSpacing = Q)
                              : u.removeAttr("cellSpacing"),
                            R !== "" ? (u[0].align = R) : u.removeAttr("align"),
                            H !== ""
                              ? u.attr("border", H)
                              : u.removeAttr("border"),
                            H === "" || H === "0"
                              ? u.addClass("ke-zeroborder")
                              : u.removeClass("ke-zeroborder"),
                            U !== ""
                              ? u.attr("borderColor", U)
                              : u.removeAttr("borderColor"),
                            e.hideDialog().focus(),
      ...
      if (!n && (u = e.plugin.getSelectedTable())) {
        ...
        m.attr("disabled", !0);
        var I,
          n = u[0].style.width || u[0].width,
          o = u[0].style.height || u[0].height;
        n !== void 0 && (I = /^(\d+)((?:px|%)*)$/.exec(n))
          ? (p.val(I[1]), z.val(I[2]))
          : p.val("");
    ...
    cellprop: function () {
                ...
                ? /^\d*$/.test(f)
                  ? /^\d*$/.test(M)
                    ? (G.css({
                      ...
                      e.cmd.select(),
                      e.addBookmark())
                    : (alert(e.lang("invalidBorder")), A[0].focus())
                  : (alert(e.lang("invalidHeight")), j[0].focus())
                : (alert(e.lang("invalidWidth")), l[0].focus());
            },
          },
        }).div,
      ...
      (n = /^(\d+)((?:px|%)*)$/.exec(G[0].style.width || G[0].width || ""))
        ? (l.val(n[1]), m.val(n[2]))
        : l.val("");
    ...
    coldelete: function () {
      for (
        var d = e.plugin.getSelectedTable()[0],
          f = e.plugin.getSelectedRow()[0],
          h = e.plugin.getSelectedCell()[0].cellIndex,
          j = 0,
          m = d.rows.length;
        j < m;
        j++
        ...
        var p = d.rows[j],
          r = p.cells[h];
        r.colSpan > 1
          ? ((r.colSpan -= 1), r.colSpan === 1 && b(r).removeAttr("colSpan"))
          : p.deleteCell(h);
        r.rowSpan > 1 && (j += r.rowSpan - 1);
      }
      f.cells.length === 0
        ? (e.cmd.range.setStartBefore(d).collapse(!0),
          e.cmd.select(),
          b(d).remove())
        : e.cmd.selection(!0);
      e.addBookmark();
        ...
        yesBtn: {
          ...
          click: function () {
            var e = j.body.innerHTML,
              e = b.clearMsWord(
                e,
                d.filterMode ? d.htmlTags : b.options.htmlTags
              );
            d.insertHtml(e).hideDialog().focus();
          },
        },
