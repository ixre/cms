...
namespace JR.Cms.WebImpl.Mvc
{
    ...
    public static class Routes
    {
        ...
        private static void RegisterInstalledCmsRoutes(RouteCollection routes, Type cmsHandleType)
        {
            ...
            dict.Add(UrlRulePageKeys.Search, new[] { "cms_search", routePrefix + "search", urlPrefix + "search?w={0}&c={1}" });
            ...
            dict.Add(UrlRulePageKeys.CategoryPager, new[] { null, null, urlPrefix + "{0}/p{1}.html" });

            dict.Add(UrlRulePageKeys.Archive, new[] { "cms_archive", routePrefix + "{*all_html}", urlPrefix + "{0}/{1}.html" });
            ...
            routes.MapRoute(
                ...
                new { controller = cmsControllerName, action = "Category", page = 1 }, new { all_cate = "^(?!" + 
