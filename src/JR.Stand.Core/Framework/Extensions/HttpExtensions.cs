...
namespace JR.Stand.Core.Framework.Extensions
{
    public static class HttpUserAgent
    {
        ...
        /// <returns></returns>
        public static bool IsSpider(String userAgent)
        {
            ...
            bool isSpider = false;
            Array.ForEach(botNames, a => { if (userAgent.IndexOf(a, StringComparison.Ordinal) != -1) isSpider = true; });
            return isSpider;
        }
        ...
        /// <param name="userAgent"></param>
        /// <returns></returns>
        public static bool IscMobileDevice(String userAgent)
        {
            Regex b =
                new Regex(
