...
*/
        ...
        private HttpTags GetTags(int siteId)
        {
            ...
            {
                string dirPath = String.Concat(AtNet.Cms.Cms.PyhicPath, "config/s", siteId.ToString(), "/");
        ...
        {
            string js = "<script type=\"text/javascript\" src=\"?res=c2NyaXB0&amp;" + AtNet.Cms.Cms.Version + ".js\"></script>";
