    ...
    public abstract class CmsTemplateCore : IDisposable
    {
        ...
        public CmsTemplateCore()
        {
            ...
            if (settings == null)
            {
                ...
                Cms.Cache.Insert(settingCacheKey, this.TplSetting, String.Format("{0}templates/{1}/tpl.conf", AtNet.Cms.Cms.PyhicPath, this.site.Tpl));
            }
            else
            {
        ...
        {
            int _pagerNumber = 0;
            object pagerNum = AtNet.Cms.Cms.Context.Items["pagerNumber"];
            if (pagerNum == null)
            {
                _pagerNumber = 0;
            }
            ...
            AtNet.Cms.Cms.Context.Items["pagerNumber"] = _pagerNumber;
        ...
        {
            return (AtNet.Cms.Cms.Context.Items[id] ?? String.Empty).ToString();
        }
        ...
        {
            return AtNet.Cms.Cms.Language.Get(key, this.site.Language);
        ...
        protected string Comment(string format, string asc, string usePager)
        {
            ...
            ArchiveDto archive = AtNet.Cms.Cms.Context.Items["archive"] == null ? default(ArchiveDto)
                : (ArchiveDto)AtNet.Cms.Cms.Context.Items["archive"];
            if (archive.Id <= 0)
        ...
        protected string Sitemap(string categoryTag)
        {
            ...
            return AtNet.Cms.Cms.Cache.GetCachedResult(cacheKey, () =>
            {
        ...
        {
            return (AtNet.Cms.Cms.Context.Items[this.PopPagerKey()] ?? "") as string;
        }
        ...
        protected string PrevArchive(string id, string format)
        {
            ...
            if (!(archive.Id > 0)) return AtNet.Cms.Cms.Language.Get(LanguagePackageKey.ARCHIVE_NoPrevious);
        ...
        protected string SearchArchives(int siteId, string categoryTagOrModuleId, string keyword, string pageIndex, string pageSize, string format, out int pageCount, out int recordCount)
        {
            ...
            AtNet.Cms.Domain.Interface.Models.Module module = null;
            Regex keyRegex;
        ...
        protected string Category_Option(string categoryTag, string split)
        {
            ...
            object cache = AtNet.Cms.Cms.Cache.Get(cacheKey);
            ...
            //缓存
            AtNet.Cms.Cms.Cache.Insert(cacheKey, result);
