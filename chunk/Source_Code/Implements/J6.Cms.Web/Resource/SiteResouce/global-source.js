    ...
    if (window.ActiveXObject) {
        ...
        if (/MSIE\s*6\.0/.test(agent)) {
            ...
            for (var i = 0; i < lis.length; i++) {
                ...
                j6.event.add(lis[i], 'mouseout', (function (t) {
                    return function () {
