...
public class FileJsonExplor
{
	...
	private static readonly string[] sysInts = new string[] {"bin","config", "templates", "libs", "global\\.asax", "web\\.config","j6.config" };

	private static string[] readOnlyFiles;
	
	static FileJsonExplor()
	{
		readOnlyFiles=new string[]{"j6.config","web.config","install.lock","global.asax"};
	}
