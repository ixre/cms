...
namespace Ops.Cms
{
    ...
    public class CmsContext
    {
        ...
        static CmsContext()
        {
            ErrorFilePath = AppDomain.CurrentDomain.BaseDirectory + "logs/error.log";
        }
        ...
        public string SiteAppPath
        {
            get
            {
            	return this.IsVirtualDirectoryRunning?"/"+ this.CurrentSite.DirName:"/";
            }
        }
        ...
        private PageDataItems dataItems;
            ...
            get
            {
                if (siteDomain == null)
                {
                    string host = String.Format("{0}{1}", context.Request.Url.Host,
                      ...
                      siteDomain= String.Format("http://{0}{1}{2}",
                                      host,
