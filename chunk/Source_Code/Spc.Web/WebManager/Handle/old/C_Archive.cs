...
namespace Ops.Cms.WebManager
{
    ...
    /// 文档
    /// </summary>
    public class C_Archive : BasePage
    {
...
*/
        ...
        {
            string js = "<script type=\"text/javascript\" src=\"?res=c2NyaXB0&amp;" + Cms.Version + ".js\"></script>";
            string css = "<link rel=\"Stylesheet\" type=\"text/css\" href=\"?res=c3R5bGU=&amp;" + Cms.Version + ".css\"/>";
