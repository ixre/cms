...
namespace Ops.Cms.WebManager
{
    ...
    public class ManagerTemplate
    {
        ...
        {
            js = "<script type=\"text/javascript\" charset=\"utf-8\" src=\"?res=c2NyaXB0&amp;" + Cms.Version + ".js\"></script>";
        ...
        public static Ops.Template.TemplateHandler<object> TemplateExc = (object obj, ref string content) =>
        {
