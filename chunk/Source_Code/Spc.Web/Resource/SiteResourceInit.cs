...
namespace Ops.Cms.Resource
{
    ...
    using System.Text;
    using System.IO;
    using Ops.Cms.Web.Resource.WebManager;
    using SharpCompress.Archive;
    using SharpCompress.Common;
    using Ops.Cms.Web.Resource;
    ...
    public class SiteResourceInit
    {
        ...
        public static void Init()
        {
            ...
            Reset(CmsVariables.FRAMEWORK_ASSETS_PATH + "common.css", 
                cssComment + ResourceUtility.CompressHtml(SiteResource.css_common),!true);
