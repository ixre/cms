...
namespace Ops.Cms.DataTransfer
{
    ...
    public struct SiteDto
    {
        ...
        /// 站点使用语言
        /// </summary>
        [FormField("language", Group = "basic", Text = "国际化/语言")]
        ...
        /// 模板
        /// </summary>
        [FormField("tpl", Group = "basic", Text = "选择模板", DisableEdit = true)]
        public string Tpl { get; set; }

        /// <summary>
        /// 站点备注
        /// </summary>
        [FormField("note", Group = "basic", Text = "站点备注", MultLine = true, Length = "[0,150]")]
        public string Note { get; set; }

        /// <summary>
        /// 站点状态
        /// </summary>
        [FormField("State", Group = "basic", Text = "站点状态")]
