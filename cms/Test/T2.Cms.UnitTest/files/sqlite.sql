...
CREATE TABLE "cms_archive" ("id" integer PRIMARY KEY  NOT NULL ,"str_id" varchar(16) NOT NULL  DEFAULT (null) ,"alias" varchar(50),"cid" integer DEFAULT (0) ,"author_id" integer DEFAULT (null) ,"title" varchar(100),"flags" varchar(100),"tags" varchar(100),"outline" varchar(255),"content" memo,"thumbnail" varchar(150),"view_count" integer DEFAULT (0) ,"agree" integer,"disagree" integer,"createDate" datetime,"lastModifyDate" datetime,"source" nvarchar(50),"location" nvarchar(150),"small_title" varchar(100),"sort_number" INTEGER NOT NULL  DEFAULT (0) );
