...
namespace JR.Cms.Core
{
    ...
    public class CmsContext
    {
        ...
        private DeviceType GetUserDeviceSet(HttpContext ctx)
        {
            ...
            if (IsMobileAgent(ctx.Request) || this.Host.StartsWith("m.") || this.Host.StartsWith("wap."))
                //如果包含手机的域名或agent
            {
