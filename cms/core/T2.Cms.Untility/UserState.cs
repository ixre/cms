...
namespace T2.Cms.Utility
{
    ...
    public static class UserState
    {
        ...
        public static class Member
        {
            ...
            /// 当前登录的会员
            /// </summary>
            public static global::T2.Cms.Domain.Interface.Models.Member Current
            {
                get
                {
                    global::T2.Cms.Domain.Interface.Models.Member m = HttpContext.Current.Session["member"] as global::T2.Cms.Domain.Interface.Models.Member;
                    if (m == null)
                    {
