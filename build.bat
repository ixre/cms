...
"%megdir%ILMerge.exe" /closed /ndebug /targetplatform:v4 /target:dll /out:%dir%dist\ops.cms.dll^
 ...
 Ops.Cms.DB.dll Ops.Cms.Cache.dll Ops.Cms.Domain.Implement.Site.dll Ops.Cms.Infrastructure.dll ^
 Ops.Cms.Service.dll Ops.Cms.ServiceContract.dll^
 Ops.Cms.ServiceUtil.dll Ops.Cms.ServiceRepository.dll Spc.IDAL.dll^
 Spc.Sql.dll Ops.Cms.Utility.dll StructureMap.dll Ops.Cms.Web.dll
