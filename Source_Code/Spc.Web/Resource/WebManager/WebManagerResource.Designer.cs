...
namespace Ops.Cms.Web.Resource.WebManager {
    ...
    public class WebManagerResource {
        ...
        /// <summary>
        ///   查找类似 eval(function (p, a, c, k, e, r) { e = function (c) { return (c &lt; a ? &apos;&apos; : e(parseInt(c / a))) + ((c = c % a) &gt; 35 ? String.fromCharCode(c + 29) : c.toString(36)) }; if (!&apos;&apos;.replace(/^/, String)) { while (c--) r[e(c)] = k[c] || e(c); k = [function (e) { return r[e] }]; e = function () { return &apos;\\w+&apos; }; c = 1 }; while (c--) if (k[c]) p = p.replace(new RegExp(&apos;\\b&apos; + e(c) + &apos;\\b&apos;, &apos;g&apos;), k[c]); return p }(&apos;I 1X(){8.ae=\&apos;3.1\&apos;;8.6n=\&apos;\&apos;;8.7K=13}1X.Z={7L:I(){G(8.7K){8.7M()}F f=L.1p(\&apos;5e\&apos;);F s=f[f.O-1];F g=s.1S [字符串的其余部分被截断]&quot;; 的本地化字符串。
        /// </summary>
        ...
        ///        &lt;link href=&quot;http://www.ops.cc/cms/help.html&quot; text=&quot;帮助指南&quot; title=&quot;&quot; siteid=&quot;-1&quot;/&gt;
        ///        &lt;link href=&quot;http://www.ops.cc/cms/about.html&quot; text=&quot;关于系统&quot; title=&quot;&quot; sitei [字符串的其余部分被截断]&quot;; 的本地化字符串。
        /// </summary>
