...
namespace Ops.Cms
{
    ...
    public class PageUtility
    {
        ...
        const string copyStr = "<!-- power by ops.cms v {0} -->";
        ...
        /// 编译模板
        /// </summary>
        private static TemplateHandler<object> CompliedTemplate = (object classInstance, ref string html) =>
        {
...
* 欢迎访问 http://www.ops.cc/soft/opsite.html 获取详细信息及试用版本。
