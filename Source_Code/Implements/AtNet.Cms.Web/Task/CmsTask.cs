...
using AtNet.DevFw.Framework.TaskBox;
using AtNet.DevFw.Framework.TaskBox.Toolkit;

namespace AtNet.Cms.Web.Task
{
    ...
    public static class CmsTask
    {
        ...
        private static void RegistDropMemoryTask()
        {
            ...
            {
                ITask task = new AtNet.DevFw.Framework.TaskBox.Task();
